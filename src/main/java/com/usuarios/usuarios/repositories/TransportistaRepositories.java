...
public interface TransportistaRepositories extends CrudRepository<Transportista,Integer>{
   ...
   //Area de Consultas a BD
    ...
    @Query(value = "update transportista  set estado=1028, fecha_modificacion= :pfecham where numero_licencia= :plicencia", nativeQuery = true)
    ...
    @Query(value = "select * from transportista where estado=1020 and numero_licencia=:pa", nativeQuery = true)
    @Transactional
    public List<Transportista> consultaLicencia( @Param("pa")String a);
